...
<html>
  <head>
   ...
   <title>Ctrl Equipos de Golf</title>
    ...
    <link rel="shortcut icon" href="../public/img/bsf.ico">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> Control Equipos de Golf Almacen</span>
    </a>
...
?>
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!--<li><a href="departamento.php"><i class="fa fa-circle-o"></i> Zona</a></li> -->
          </ul>
      </li>
      ...
      <li class="treeview">
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Monitoreo Asistencia</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
